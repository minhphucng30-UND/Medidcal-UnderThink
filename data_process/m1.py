...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--local_save_dir", default="data/m1", help="The save directory for the preprocessed dataset."
    )

    args = parser.parse_args()

    data_source = "UCSC-VLAA/m1k-tokenized"
    ...
    def make_map_fn(split):
        def process_fn(example, idx):
            ...
            response =  "\n<think>\n" + example["reasoning"] + "\n</think>\n" + example["distilled_answer_string"]
            solution = example["answer_letter"]
            answer_raw = example["answer_string"]
            data = {
